...
const projects = [
  {
    ...
    desc: "Sistema completo de tickets e manutenção de computadores com dashboard, gestão de clientes e relatórios em tempo real.",
  ...
  },
  {
    ...
    tag: "Frontend · Marketing",
    desc: "Landing page de alta conversão com animações Framer Motion, seção de preços e integração com formulário de leads.",
  ...
  },
  {
    ...
    desc: "API RESTful completa com autenticação JWT, CRUD de usuários, upload de arquivos e documentação automática Swagger.",
